...
apt-get install -y --ignore-missing python python2.7 python3 python-pip python3-pip python-dev python3-dev python-setuptools python3-setuptools
...
apt-get install -y --ignore-missing zlib1g-dev libcurl4-openssl-dev liblzma-dev libxml2 libxml2-dev libxslt1-dev build-essential libgmp-dev 
apt-get install -y --ignore-missing gcc make automake patch libssl-dev locate libffi-dev libxml2-utils
